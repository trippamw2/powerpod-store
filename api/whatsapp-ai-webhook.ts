...
const KNOWLEDGE = {
  products: "We sell: Phones (Samsung, Xiaomi), Earbuds (Apple, Oraimo), Chargers, Powerbanks, Speakers, Cables",
  ...
  warranty: "6 months warranty on electronics, 7 days return with receipt",
  hours: "Mon-Sat 8am-6pm, Sun 9am-4pm",
  location: "Based in Blantyre, Malawi - Online orders at powerpod-store.vercel.app",
};
...
function getResponse(input: string): string {
  ...
  if (msg.includes('hi') || msg.includes('hello') || msg.includes('hey') || msg.includes('start')) {
    return `👋 Hey! Welcome to PowerPod!\n\nWe sell electronics: 📱🎧🔋\n\nHow can I help?`;
  }
