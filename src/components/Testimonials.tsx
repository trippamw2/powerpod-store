  ...
  const getDefaultTestimonials = (): Testimonial[] => [
    {
      ...
      message: "PowerPods saved my campus life! Best sound quality for studying and the delivery was super fast.",
      rating: 5,
      image: "",
      is_active: true,
      sort_order: 1,
    ...
    },
    {
      ...
      message: "Best accessories in Malawi. My hotel guests love the speakers. Fast delivery across Malawi!",
      rating: 5,
      image: "",
      is_active: true,
      sort_order: 2,
    ...
    <section className={`py-12 ${className}`}>
      <div className="container">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground mt-2">Real reviews from real PowerPod customers</p>
        </div>
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="What did they say about PowerPod..."
                  rows={4}
                  required
                />
              </div>
