...
PowerPod Store Information:
- We sell electronics: phones, earbuds, chargers, powerbanks, speakers
- Brands: Apple, Samsung, Xiaomi, Huawei, Oraimo
...
📱 Phones, 🎧 Earbuds, 🔋 Powerbanks, 🔌 Chargers
...
What's your location?`,
    ...
    if (lowerMsg.includes('where') || lowerMsg.includes('location') || lowerMsg.includes('shop')) {
      return {
        response: `📍 PowerPod Store

We're based in Blantyre, Malawi!

Order online: powerpod-store.vercel.app
...
Open: Mon-Sat 8am-6pm, Sun 9am-4pm`,
    ...
    if (lowerMsg.includes('hi') || lowerMsg.includes('hello') || lowerMsg.includes('hey')) {
      return {
        response: `👋 Hey! Welcome to PowerPod!

We sell phones, earbuds, chargers & more.
...
How can I help you today?`,
    ...
    if (lowerMsg.includes('warranty') || lowerMsg.includes('return') || lowerMsg.includes('repair')) {
      return {
        response: `🛡️ PowerPod Warranty & Returns:

✅ Warranty: 6 months on electronics
↩️ Returns: 7 days with receipt
📱 Repairs: Depends on issue
