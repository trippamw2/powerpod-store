        ...
        <div className="container relative py-10 sm:py-14 lg:py-20">
          ...
          <div className="relative max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-400 text-sm sm:text-base mt-3 max-w-lg mx-auto leading-relaxed">
              Dead battery before a call? Earbuds dying on the bus? We picked the power bank, 
              cable, and audio gear your phone needs. Tested. Reliable. Cheaper together.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center mt-6">
              <a
                href={buildWhatsAppLink("Hi PowerPod! Which tech kit should I pick?")}
        ...
        <div className="container py-5">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {[
              ...
              { icon: Zap, title: "No Research Needed", desc: "We matched the right parts for your phone." },
      ...
      <section className="container py-8 sm:py-12 lg:py-16">
        <div className="text-center mb-8 sm:mb-10">
          ...
          <p className="text-gray-500 text-sm mt-2 max-w-md mx-auto">
            Each kit solves a real problem. No filler. Just what your phone needs.
          </p>
        </div>
