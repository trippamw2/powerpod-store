  ...
  const faqs = [
    ...
    },
    {
      ...
      items: [
        ...
        { q: "Do products have warranty?", a: "Yes! All electronics come with at least 6 months manufacturer warranty. Warranty terms vary by product." },
    ...
    },
    {
      category: "Products",
      items: [
        { q: "Are your products genuine?", a: "Yes! We are an authorized reseller for OALE, HUAWEI, ORAIMO, and XIAOMI. All products are 100% genuine." },
  ...
  return (
    <div className="container py-10 sm:py-14 max-w-3xl">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-muted-foreground">Find answers to common questions about PowerPod</p>
      </div>
