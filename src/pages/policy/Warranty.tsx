...
const Warranty = () => {
  const warrantyInfo = [
    { brand: "OALE", period: "12 months", coverage: "Manufacturing defects" },
    { brand: "HUAWEI", period: "12 months", coverage: "Manufacturing defects" },
    { brand: "ORAIMO", period: "6 months", coverage: "Manufacturing defects" },
    { brand: "XIAOMI", period: "6 months", coverage: "Manufacturing defects" },
  ];
  ...
  return (
    <div className="container py-10 sm:py-14 max-w-3xl">
      ...
      <div className="prose prose-gray max-w-none space-y-8">
        <p className="text-muted-foreground">All PowerPod products come with manufacturer warranty for your peace of mind.</p>
